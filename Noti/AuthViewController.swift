...
class AuthViewController: NSViewController, WebFrameLoadDelegate {
    ...
    override func viewDidLoad() {
        ...
        let req = URLRequest(url:URL(string:"https://www.pushbullet.com/authorize?client_id=zvqZNUJp3uUuSIucFDcBO2cUdQKIs2CJ&redirect_uri=about:blank&response_type=token&scope=everything")!)
